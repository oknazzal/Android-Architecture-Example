...
import com.oknazzal.architecture.example.feature.authentication.presentation.BR;
...
public class FragmentRegisterBindingImpl extends FragmentRegisterBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.text_input_layout_name, 1);
        sViewsWithIds.put(R.id.edit_text_name, 2);
        sViewsWithIds.put(R.id.text_input_layout_age, 3);
        sViewsWithIds.put(R.id.edit_text_age, 4);
        sViewsWithIds.put(R.id.text_input_layout_email, 5);
        sViewsWithIds.put(R.id.edit_text_email, 6);
        sViewsWithIds.put(R.id.text_input_layout_password, 7);
        sViewsWithIds.put(R.id.edit_text_password, 8);
